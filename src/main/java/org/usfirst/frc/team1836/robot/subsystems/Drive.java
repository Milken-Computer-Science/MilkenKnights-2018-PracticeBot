...
public class Drive extends Subsystem {
    ...
    private void updatePathFollower(double timestamp) {
        double leftVel = mPathFollower.getLeftVelocity(leftfwdtalon.getMkPosition(), leftfwdtalon.getMkVelocity(), navX.getYaw());
        double rightVel = mPathFollower.getRightVelocity(rightfwdtalon.getMkPosition(), rightfwdtalon.getMkVelocity(), -navX.getYaw());
