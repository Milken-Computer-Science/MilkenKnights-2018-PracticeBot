 ...
 * decomposition is an lower triangular matrix L so that A = L*L'. <P> If the matrix is not
 * symmetric or positive definite, the constructor returns a partial decomposition and sets an
