package frc.team1836.robot.subsystems.vision;
...
public class PixySPI {
	...
	public int readPackets() throws PixyException { //The signature should be which number object in 
		...
		// Uncomment this to see just the raw output from the Pixy. You will need to restart the frc.team1836.robot code
		// to kill this.
		//rawComms();
