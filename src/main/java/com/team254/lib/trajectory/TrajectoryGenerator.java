...
public class TrajectoryGenerator {
	...
	/**
	 * Generate a trajectory from a start state to a goal state. <p> Read the notes on each of the
	 * Strategies defined above, as certain arguments are ignored for some strategies.
	 *
